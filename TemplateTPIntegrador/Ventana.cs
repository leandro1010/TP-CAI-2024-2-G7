...
namespace Presentacion
{
    public partial class Ventana : Form //Se crea nuevo formularo base para que el resto de los formularios hereden el formato.
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Dibujar el borde
            ControlPaint.DrawBorder(e.Graphics, new Rectangle(0, 0, width, height), Color.Purple, borderWidth, ButtonBorderStyle.Solid, Color.Purple, borderWidth, ButtonBorderStyle.Solid, Color.Purple, borderWidth, ButtonBorderStyle.Solid, Color.Purple, borderWidth, ButtonBorderStyle.Solid);
        } // Dibuja un Borde Violeta a la Ventana
