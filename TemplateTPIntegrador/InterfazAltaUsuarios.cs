...
namespace Presentacion
{
    public partial class InterfazAltaUsuarios : Ventana
    {
        ...
        private string GenerarCredenciales(string nombre, string apellido, string dni)
        {
            ...
            string PrimeraLetraNombre = nombre.Length >= 2 ? nombre.Substring(0, 1) : nombre;
            ...
            string nombreUsuario = $"G7{PrimeraLetraNombre.ToUpper()}{apellido.ToUpper()}{tresUltimosDigitosDNI}";
