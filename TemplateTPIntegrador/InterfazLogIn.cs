...
namespace Presentacion
{
    public partial class InterfazLogIn : Ventana
    {
        ...
        private void CargarTXT(string Usuario, string id)
        {
            ...
            // Filtrar usuarios cuyo NombreUsuario empiece por "G7"
            listaUsuarios = listaUsuarios.Where(u => u.NombreUsuario.StartsWith("G7")).ToList();
        ...
        private void PassViewImg_Click(object sender, EventArgs e)
        {
